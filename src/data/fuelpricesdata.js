const paragraph1 = `Over the last few decades, fluctuations have existed in prices
...
const paragraph2 = `Currently, fuel pump prices in Nigeria stand at:
-Gasoline/petrol price: N165.8/litre
-Diesel price: N289.4/litre
-Kerosene price: N468.0 
Findings show that these prices place Nigeria as
the seventh cheapest nation in terms of fuel pump price and the
lowest in West Africa.`;

const paragraph3 = `Unlike most products, oil prices are not determined entirely by
...
const paragraph4 = `The effects on demand, however, have a great potential impact on
